...
public class Server implements ServerInterface {
	...
	public void setGameData(HashMap<String, String> gameData) {
		/*
		 * Structure should be like this: pregunta = pregunta resposta1 = resposta1
		 * resposta2 = resposta2 ... temps_preguntes = Y segons temps_inici = X segons
		 */
	...
	public void answer(String uname, String answer) {
		...
		if (answer.equals(getCorrect())) {
			...
			Integer oldPts = getRanking().get(uname);
